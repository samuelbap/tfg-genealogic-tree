<footer class="max-h-64 bg-white text-gray-600 body-font">
  <div class="max-h-32 container mx-auto">
    <div
      class=" max-h-32 container mx-auto flex flex-wrap md:text-left text-center"
    >
      <nav class="max-h-10 w-full m-6 flex list-none md:m-0">
        <li class=" m-3 lg:w-1/4 md:w-1/2 w-full">
  ...
  <div class="max-h-320 border-t border-gray-200">
      ...
      >
        <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
          <label for="footer-field" class="leading-7 text-sm text-gray-600"
            >Buscas Informacion?, te contactamos:</label
          >
          <input
            type="text"
            id="footer-field"
            name="footer-field"
            placeholder="user@mail.com/000-000000"
        ...
        <button
          class="inline-flex text-white bg-blue-700 border-0 py-2 px-6 focus:outline-none hover:bg-blue-300 hover:text-gray-700 rounded"
          >Button</button
        >
        <p
          class="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center"
        >
          Hystory of the world become in a list.
          <br class="lg:block hidden" />
          Keep calm, if we can't we have helped find what you are looking for, it
          will be soon.
        </p>
      </div>
      <span
  ...
  <div class="bg-gray-100">
    <div
      class=" max-h-32 container mx-auto p-1 flex flex-wrap flex-col sm:flex-row"
    >
